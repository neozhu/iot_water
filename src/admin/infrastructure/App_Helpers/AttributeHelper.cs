...
namespace WebApp
{
  public static class AttributeHelper
  {
    ...
    private static string GetAttributeDisplayName(PropertyInfo property)
    {
      ...
      var disattr = atts[0] as System.ComponentModel.DataAnnotations.DisplayAttribute;
      return string.IsNullOrEmpty(disattr.Description) ? disattr.Name:disattr.Description;
    }
