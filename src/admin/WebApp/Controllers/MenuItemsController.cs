...
namespace WebApp.Controllers
{
  ...
  public class MenuItemsController : Controller
  {
    ...
    public ActionResult Create()
    {
      ...
      ViewBag.ParentId = new SelectList(this.menuItemService.Queryable().OrderBy(n => n.Title), "Id", "Title");
      return View(menuItem);
    }
    ...
    {
      ViewBag.ParentId = new SelectList(await this.menuItemService.Queryable().OrderBy(n => n.Title).ToListAsync(), "Id", "Title");
