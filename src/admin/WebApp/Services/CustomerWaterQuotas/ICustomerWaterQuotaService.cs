...
{
  /// <summary>
  /// File: ICustomerWaterQuotaService.cs
  ...
  /// Created Date: 3/25/2020 10:35:48 PM
  /// Author: neo.zhu
  /// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
  /// Copyright (c) 2012-2018 All Rights Reserved
  /// </summary>
  public interface ICustomerWaterQuotaService : IService<CustomerWaterQuota>
  {
    Task<IEnumerable<CustomerWaterQuota>> GetByCustomerIdAsync(int customerid);
