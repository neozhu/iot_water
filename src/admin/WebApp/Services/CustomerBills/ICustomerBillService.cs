...
namespace WebApp.Services
{
  ...
  /// Created Date: 3/28/2020 3:02:39 PM
  /// Author: neo.zhu
  /// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
  /// Copyright (c) 2012-2018 All Rights Reserved
  /// </summary>
  public interface ICustomerBillService : IService<CustomerBill>
  {
    Task<IEnumerable<CustomerBill>> GetByCustomerIdAsync(int customerid);
