...
{
/// <summary>
/// File: IZoneWaterMeterService.cs
...
/// Created Date: 3/28/2020 6:45:16 PM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
    public interface IZoneWaterMeterService:IService<ZoneWaterMeter>
    {
         Task<IEnumerable<ZoneWaterMeter>> GetByZoneIdAsync(int  zoneid);
