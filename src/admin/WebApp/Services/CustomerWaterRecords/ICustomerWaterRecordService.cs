...
{
  /// <summary>
  /// File: ICustomerWaterRecordService.cs
  ...
  /// Created Date: 3/25/2020 10:40:59 PM
  /// Author: neo.zhu
  /// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
  /// Copyright (c) 2012-2018 All Rights Reserved
  /// </summary>
  public interface ICustomerWaterRecordService : IService<CustomerWaterRecord>
  {
    Task<IEnumerable<CustomerWaterRecord>> GetByCustomerIdAsync(int customerid);
    ...
    Task Delete(int[] id);
    Task AutoRecordMonth(int year,int month,string user);
    Task AddRecord(CustomerWaterRecord item);
    Task Stop(int[] id);
  }
}