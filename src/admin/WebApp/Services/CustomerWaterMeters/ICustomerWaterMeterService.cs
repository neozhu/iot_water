...
{
/// <summary>
/// File: ICustomerWaterMeterService.cs
...
/// Created Date: 3/25/2020 10:26:39 PM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
    public interface ICustomerWaterMeterService:IService<CustomerWaterMeter>
    {
         Task<IEnumerable<CustomerWaterMeter>> GetByCustomerIdAsync(int  customerid);
