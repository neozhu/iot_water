...
{
/// <summary>
/// File: WaterManualRecordQuery.cs
...
/// </summary>
   public class WaterManualRecordQuery:QueryObject<WaterManualRecord>
   {
		public WaterManualRecordQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
